...
import {MenuService} from '@shared/component/services/menu.service';

@Component({
  selector: '[app-menuitem]',
  standalone: true,
  imports: [
    NgClass, NgForOf, RouterLink, RouterLinkActive, DockModule, NgIf, Ripple, Ripple
  ],
  template: `
    <ng-container>
...
export class MenuitemComponent implements OnInit, OnDestroy{
  ...
  constructor(public layoutService: LayoutService, private cd: ChangeDetectorRef, public router: Router, private appSidebar: SidebarComponent, private menuService: MenuService) {
